...
export const convertAudio = (video: File) => {
  ...
  return new Promise((resolve) => {
    reader.onload = (e) => {
      ...
      audioContext
        ...
        .then(function (decodedAudioData: AudioBuffer) {
          ...
          offlineAudioContext
            ...
            .then(function (renderedBuffer) {
              ...
              let convertedAudio = {
                name: video.name.substring(0, video.name.lastIndexOf(".")),
                format: targetAudioFormat,
                data: blobUrl,
                file: new File([blob], "audio_file"),
              };
